            ...
            <div class="filters">
                ...
                <label>Min Age
                    <input type="number" name="min_age" min="18" max="120"
                        value="<?= escaped((string) $filters['min_age']) ?>">
                </label>
                <label>Max Age
                    <input type="number" name="max_age" min="18" max="120"
                        value="<?= escaped((string) $filters['max_age']) ?>">
                </label>
                <label>Country
            ...
            <section class="results" aria-live="polite">
                ...
                <?php foreach ($results as $profile): ?>
                    <article class="profile">
                        ...
                        <p><?= escaped(ucfirst($profile['gender'])) ?> · <?= escaped($profile['city']) ?>,
                            <?= escaped($profile['country']) ?></p>
